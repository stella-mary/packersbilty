...
import "./NewPaymentData.css";
import NewPayment from '../../Images/NewPayment.png';
import { useNavigate } from 'react-router-dom';


export default function NewPaymentList() {

    const navigate = useNavigate()

    function movetobackPayment() {
        navigate("/Payment")
    }
    ...
    return (
        <div className='ContainerSurvey'>
            <div className='ContainerSurveyMain'>
                <h1 class="SurveyTitle">Payment List</h1>
                <p class="SurveyRight">Total Payment List: 0</p>
            </div>
            ...
            <div className='ContainerSurveySub'>
                <p className='imageSurvey'><img src={NewPayment} alt="" width={250}></img></p>
                ...
                <hr />
                <button onClick={movetobackPayment} className='SurveyButton'>Add New Payment List</button>
            </div>
        </div>
    )
}
