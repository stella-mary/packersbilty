...
import "./NewLorryData.css";
import NewLorry from '../../Images/NewLorry.png';
    ...
    return (
        <div className='ContainerSurvey'>
            <div className='ContainerSurveyMain'>
                <h1 class="SurveyTitle">Lorry List</h1>
                <p class="SurveyRight">Total Lorry List: 0</p>
            </div>
            ...
            <div className='ContainerSurveySub'>
                <p className='imageSurvey'><img src={NewLorry} alt="" width={250}></img></p>
                ...
                <hr />
                <button onClick={movetobackLorry} className='SurveyButton'>Add New Lorry List</button>
            </div>
        </div>
    )
}
