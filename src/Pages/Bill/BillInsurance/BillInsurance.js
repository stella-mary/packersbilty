    ...
    return (
        <div className='BillInsuranceMain'>
            ...
            {show ? <p>{<div className='BillInsuranceForm'>
                ...
                <select
                    name="ffinsuranceType" required
                    id="ffinsuranceType"
                    value={userInfo.ffinsuranceType}
                ...
                <select
                    name="ffinsuranceCharge" required
                    id="ffinsuranceCharge"
                    value={userInfo.ffinsuranceCharge}
                    onChange={handleOnChange}
                >
                ...
                <text type="text"
                    name="ffdeclaration" required
                    id="ffdeclaration"
                    value={userInfo.ffdeclaration}
                    onChange={handleOnChange}
                >
                </text>
            </div>}</p> : null}
